...
\begin{ressection}{Experience}
	...
	\begin{ressubsec}{IKEA Long Island}{Hicksville, NY}{Cashier: December 2009--August 2010, June 2011--August 2019, April 2012--Present}
...
\begin{ressection}{Skills}
	...
	\begin{reslist}{Computer Languages:}
		...
		\ressubitem{Familiar with Perl, HTML, SQL, PHP, Bash, ZSH, and other UNIX shells}
...
\end{ressection}
\textbf{\hfil Personal blog:\hfill \LaTeX source:\hfil}
\newline
\hfill
\begin{pspicture}(1in,1in)
	\psbarcode{http://blog.agargiulo.com/resume.pdf}{eclevel=L width=1.0 height=1.0}{qrcode}
\end{pspicture}
\hfill
\begin{pspicture}(1in,1in)
