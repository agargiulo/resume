...
\pagestyle{empty}
\geometry{letterpaper,tmargin=0.22in,bmargin=0.22in,lmargin=0.55in,rmargin=0.55in,headheight=0in,headsep=0in,footskip=.1in}
...
\begin{ressection}{Experience}
	...
	\begin{ressubsec}{Constant Contact}{Waltham, MA\hfill October 2014 -- present}{Continuous Delivery CoOp}
		\ressubitem{Worked on internal tools to aid teams in continuously deploying their code}
		\ressubitem{Most time was spent writing Ruby, also contributed to \textbf{jenkins pipeline builder}, a tool to programmatically create and maintain Jenkins jobs}
	\end{ressubsec}
