...
\begin{ressection}{Experience}
	...
	\begin{ressubsec}{IKEA Long Island}{Hicksville, NY}{Cashier: December 2009--August 2010, June 2011--August 2019d}
	...
	\begin{ressubsec}{Bethpage School District}{Bethpage, NY}{Summer Camp Teacher: 2011}
		\ressubitem{Tought 4th to 7th grade students in a "Video Game Design" class for a summer tech camp.}
		\ressubitem{Involved making lesson plans, and teaching topics ranging from simple flow control to variable use, etc...}
		\ressubitem{Class was tought using a spin of MIT Scratch, named BYOB (Build Your Own Blocks)}}
...
\begin{ressection}{Skills}
	...
	\begin{reslist}{Computer Languages:}
		...
		\ressubitem{Familiar with HTML, \LaTeX, SQL, PHP, UNIX Shells}
	...
	\begin{reslist}{Tools and Systems:}
		...
		\ressubitem{Familiar with MySQL, PostgreSQL, OpenLDAP, Samba}
