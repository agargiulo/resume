...
\begin{ressection}{Experience}
	...
	\begin{ressubsec}{Computer Science House}{Rochester, NY}{System Administrator: September 2011-present}
		\ressubitem{Responsible for the maintenance of services for the organization. Services include mail, kerberos, news, web, shell access }
	\end{ressubsec}
...
\textbf{Digital copy:}
\newline
\begin{pspicture}(0.75in,0.75in)
		\psbarcode{http://resume.anthonygargiulo.info}{eclevel=H width=0.75 height=0.75}{qrcode}
\end{pspicture}
