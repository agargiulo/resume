...
%%%
%%%  	\ressubitem{Seeking full time employment in the field of system/network administration or production engineering.}
%%%
%%%  \end{ressection}
%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{ressection}{Skills}
	...
	\begin{reslist}{Programming Languages:}
		\ressubitem{Proficient in Ruby, Perl, Python, Java, Bash/ZSH}
		\ressubitem{Familiar with SQL, PHP, \LaTeX, C/C++, MIPS, x86 asm}
	\end{reslist}

	\begin{reslist}{Tools and Software:}
		\ressubitem{Proficient with Vim, Git, Apache, Puppet, Jenkins}
		\ressubitem{Familiar with Salt, Vagrant, Travis CI, Subversion, ISC-DHCPD, Cisco IOS, PostgreSQL, OpenLDAP}
		\ressubitem{Operating Systems: Linux (Fedora/RHEL, Debian, Gentoo), MacOS}
	\end{reslist}
...
\begin{ressection}{Experience}
	...
	\begin{ressubsec}{LinkedIn}{San Francisco, CA\hfill October 2016 -- present}{Site Reliability Engineer}
		\ressubitem{Support multiple microservices that support slideshare.net}
		\ressubitem{Including monitoring/alerting, configuration management, build and deploy pipelines, and more}
	\end{ressubsec}
