...
\begin{pspicture}(1in,1in)
	\psbarcode{http://resume.anthonygargiulo.info/resume.pdf}{eclevel=L width=1.0 height=1.0}{qrcode}
\end{pspicture}
\hfill
\begin{pspicture}(1in,1in)
	\psbarcode{http://resume.anthonygargiulo.info/resume.tex.html}{eclevel=L width=1.0 height=1.0}{qrcode}
\end{pspicture}
\hfill
